...
import { deleteRailwayProject, listRailwayProjectSummaries, RailwayApiError } from "@/app/api/_lib/railway";

export const runtime = "nodejs";

/** Lists every project on the caller's real Railway account — used by "Import Project". */
export const GET = withErrorHandling(async (req: NextRequest) => {
  ...
  try {
    const projects = await listRailwayProjectSummaries(railwayToken);
    return ok(projects);
  } catch (e) {
